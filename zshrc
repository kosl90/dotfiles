...
plugins=(zsh_reload git git-extras extract urltools vundle python debian npm mercurial node rvm svn tmux go rake ruby gem cabal pip docker sbt scala nmap autojump rails nvm)
